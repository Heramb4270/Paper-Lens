        ...
        <div>
            <form className="max-w-screen-md mx-auto" onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                    {/* Student File Upload */}
                    <div>
                        <label htmlFor="student-file" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Student File</label>
                        {studentFileName ? (
...
<div className="flex flex-col items-center justify-center pt-5 pb-6">
    ...
    <p className="text-xs text-gray-500 dark:text-gray-400">{studentFileName}</p>
                            ...
                            <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                ...
                                <input id="dropzone-file" type="file" class="hidden" accept=".pdf" onChange={handleStudentFileChange} />
                            </label>
                        </div>
                        )}
                    </div>
                    ...
                    <div className="mt-3">
                        <label htmlFor="answersheet-file" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Answer Sheet</label>
                        {answersheetFileName ? (
                           <div className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" onClick={() => setFile(null)}>
                           <div className="flex flex-col items-center justify-center pt-5 pb-6">
                               <p className="mb-2 text-sm text-gray-500 dark:text-gray-400 font-semibold">File uploaded successfully</p>
                            ...
                            <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                ...
                                <input id="dropzone-file" type="file" class="hidden" accept=".pdf" onChange={handleAnswersheetFileChange} />
                            </label>
                        </div>
                        )}
                    </div>
