        ...
        <form className="mx-auto mt-5">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div className="mb-5">
              ...
              <input type="number" id="pnr" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required placeholder="eg. 1234567890" />
            </div>
            <div className="mb-5">
